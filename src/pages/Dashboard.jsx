...
function Dashboard({
            ...
            .map(
              recurringTask => ({
                ...
                task_date:
                  selectedDate,
                start_time:
                  recurringTask.start_time,
                end_time:
                  recurringTask.end_time,
                goal_id:
                  recurringTask.goal_id ||
                  null,
                milestone_id:
                  recurringTask.milestone_id ||
                  null,
                area_id:
                  recurringTask.area_id ||
                  null,
                deadline:
                  recurringTask.deadline ||
                  null
              })
            )
  ...
  async function bringCarryoverToToday(
    task
  ) {
    setActionError('')
    ...
    if (existingError) {
      showActionError(
        'Could not check the carryover task. Please try again.',
        existingError
      )
      return
    }
    ...
    if (error) {
      showActionError(
        'Could not bring this task to today. Please try again.',
        error
      )
      return
    }
  ...
  async function skipCarryover(
    ...
    if (error) {
      showActionError(
        'Could not skip this task. Please try again.',
        error
      )
      return
    }
  ...
  async function rescheduleCarryover(
    task
  ) {
    setActionError('')
    ...
    if (error) {
      showActionError(
        'Could not reschedule this task. Please try again.',
        error
      )
      return
    }
  ...
  async function carryOverTask(
    ...
    if (existing?.length) {
      window.alert(
        'This task is already carried over to today.'
      )
    ...
    if (error) {
      ...
      window.alert(
        'Could not carry over this task.'
      )
  ...
  async function carryOverYesterdayTasks() {
    ...
    if (
      ...
      window.alert(
        "Yesterday's unfinished tasks are already carried over."
      )
    ...
    if (error) {
      ...
      window.alert(
        'Could not carry over the unfinished tasks.'
      )
  ...
  async function startFocus() {
    ...
    if (error) {
      if (
        ...
        setActionError(
          'A focus session is already running in another tab or window.'
        )
      } else {
        showActionError(
          'Could not start the focus session. Please try again.',
          error
        )
      }
  ...
  async function stopFocus() {
    ...
    if (error) {
      showActionError(
        'Could not stop the focus session. Please try again.',
        error
      )
      return
    }
  ...
  async function editTask(
    ...
    if (choice === '1') {
      ...
      if (error) {
        showActionError(
          'Could not edit this occurrence. Please try again.',
          error
        )
        return
      }
    ...
    if (recurringFetchError) {
      showActionError(
        'Could not load the recurring task. Please try again.',
        recurringFetchError
      )
      return
    }
    ...
    if (ruleError) {
      showActionError(
        'Could not update the recurring rule. Please try again.',
        ruleError
      )
      return
    }
    ...
    if (futureError) {
      showActionError(
        'Could not update future occurrences. Please try again.',
        futureError
      )
      return
    }
  ...
  async function deleteTask(
    ...
    if (
      ...
      if (recurringError) {
        showActionError(
          'Could not stop the recurring task. Please try again.',
          recurringError
        )
        return
      }
      ...
      if (deleteFutureError) {
        showActionError(
          'Could not delete future occurrences. Please try again.',
          deleteFutureError
        )
        return
      }
  ...
  async function toggleFocus(
    ...
    if (error) {
      showActionError(
        'Could not update focus status. Please try again.',
        error
      )
      return
    }
